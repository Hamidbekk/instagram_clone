...
from .models import User, UserConfirmation, VIA_EMAIL, VIA_PHONE, NEW, CODE_VERIFIED, DONE, PHONE_EXPIRE, PHOTO_STEP
...
class ChangeUserInformation(serializers.Serializer):
    ...
    def validate_first_name(self, first_name):
        ...
        if first_name.isdigit():
            raise ValidationError(
                {
                    "message": "This first_name is entirely numeric"
                }
            )
        return first_name
...
class LoginSerializer(TokenObtainPairSerializer):
    ...
    def auth_validate(self, data):
        ...
        if check_user_type(user_input) == 'username':
            ...
            user = self.get_user(email__iexact=user_input) # user get method orqali user o'zgaruvchisiga biriktiriliadi
